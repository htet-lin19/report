...
<body onload="Password('${signUp.emp_cd}', '${sign.password}')">
...
<div><jsp:include page="menu.jsp"></jsp:include></div>
			   ...
			   <div class="col-md-6 col-md-offset-4">
				<div class='alert alert-danger' id="Error" style="display:none;"></div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="signUp.emp_cd" class="form-control" id="emp_cd" maxlength="8" value="${signUp.emp_cd}"/>	
						</div>
					</div>
					
					<div class="form-group">
						<label for="inputpassword" class="control-label col-md-4"><font color="red">*</font>パスワード</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-4">
							 <button type="submit" class="btn btn-success" id="btnInsert">サインアップ</button>
							 <button type="reset" class="btn btn-danger" id="btnClear">キャンセル</button>
						</div>
					</div>
	...
	function Password(emp_cd, password){
